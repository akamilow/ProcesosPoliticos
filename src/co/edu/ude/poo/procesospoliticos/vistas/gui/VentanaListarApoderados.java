 ...
 */
public class VentanaListarApoderados extends javax.swing.JDialog {
    
    public VentanaListarApoderados(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true), "Lista de los apoderados:", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 14), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        jScrollPane2.setViewportView(tablaApoderados);
        ...
        jLabel1.setText("LISTAR APODERADOS REGISTRADOS");
    ...
    // Cargar los partidos registrados en la tabla
        ...
        ApoderadoModelJpaController controlador = new ApoderadoModelJpaController(con);
        List<ApoderadoModel> apoderados = controlador.findApoderadoModelEntities();
        ...
        if (apoderados == null) {
            JOptionPane.showMessageDialog(this, "No hay apoderados registrados", "Información", JOptionPane.INFORMATION_MESSAGE);
            this.dispose();
            return;
        }
        ...
        for(int i = 0; i < apoderados.size(); i++) {
            ApoderadoModel a = apoderados.get(i);
            Vector<String> registro = new Vector<>();
            registro.add(String.valueOf(a.getDni()));
            // registro.add(a.getCiudadanoModel().getNombre());
            registro.add(a.getRut().toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaListarApoderados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaListarApoderados dialog = new VentanaListarApoderados(new javax.swing.JFrame(), true);
