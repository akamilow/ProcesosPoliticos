 ...
 */
public class VentanaListarMesas extends javax.swing.JDialog {
    
    public VentanaListarMesas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true), "Lista de mesas:", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 14), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        tablaMesas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Numero", "Partido", "Ubicacion", "Vocal de mesa", "Apoderado 1", "Apoderado 2", "Genero", "Estado"
            }
        ) {
        ...
        jLabel1.setText("LISTAR MESAS REGISTRADAS");
    ...
    // Cargar los partidos registrados en la tabla
        ...
        MesavotacionModelJpaController controlador = new MesavotacionModelJpaController(con);
        List<MesavotacionModel> mesas = controlador.findMesavotacionModelEntities();
        ...
        columnas.add("Vocal de mesa");
        columnas.add("Apoderado 1");
        columnas.add("Apoderado 2");
        columnas.add("Genero");
        columnas.add("Estado");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaListarMesas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaListarMesas dialog = new VentanaListarMesas(new javax.swing.JFrame(), true);
