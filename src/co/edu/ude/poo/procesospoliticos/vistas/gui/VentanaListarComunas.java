...
public class VentanaListarComunas extends javax.swing.JDialog {
    ...
    public void cargarPartidos() {
        ...
        ComunaModelJpaController controlador = new ComunaModelJpaController(con);
        List<ComunaModel> comunas = controlador.findComunaModelEntities();
        ...
        if (comunas == null) {
            JOptionPane.showMessageDialog(this, "No hay comunas registradas", "Información", JOptionPane.INFORMATION_MESSAGE);
            this.dispose();
            return;
        }
        Vector<String> columnas = new Vector<>();
        columnas.add("ID");
        columnas.add("Nombre de comuna");
